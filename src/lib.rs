...
/// Common consists of the commonly shared types.
/// More specifically, the types sent across the network between the flight computer,
/// control server, GUI, and SAM boards are all stored here.
...
/// Trait providing a method to create a pretty, terminal-friendly representation of the underlying code.
pub trait ToPrettyString {
    ...
    /// but would be atypical in a `fmt::Display` implemention.
